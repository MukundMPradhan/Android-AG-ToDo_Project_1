...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        /*pRadioComplete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                pRadioInComplete.setChecked(false);
            }
        });
       pRadioInComplete.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View v) {
               pRadioComplete.setChecked(false);
           }
       });*/
